...
<body>
    ...
    <main>
        <div class="container">
            <div class="row mt-3">
                <div class="col">
                    <h2 class="d-flex justify-content-center mb-3">Facturación</h2>
                    <form id="procesar-pago" method="post">
                        ...
                        <div class="row justify-content-between">
                            <div class="col-md-4 mb-2">
                                <a href="tienda.php" class="btn btn-info btn-block">Volver atrás</a>
                            </div>
                             <div class="col-md-4 mb-2">
                                <a href="informe.php" class="btn btn-info btn-block">imprimir</a>
                            </div>
                        </div>
                    </form>
