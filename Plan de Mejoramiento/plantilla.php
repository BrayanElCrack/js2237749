<?php
	...
	class PDF extends FPDF
	{
		function Header()
		{
			$this->Image('img/logo.jpg', 5, 5, 20 );//sintaxis Image('ruta',posision x, posicion y, tamaño)
			...
			$this->Cell(120,10, 'FACTURA DE COMPRA',0,0,'C'); //celda titulo(ancho, altura,'titulo', contorno, salto de linea,'alineacion')
